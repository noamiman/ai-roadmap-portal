        ...
        if key.lower() == "home":
            ...
            <div class="welcome-container">
                <div class="welcome-card">
                    <h1>AI Roadmap: מהבסיס ועד לקצה הטכנולוגיה 🚀</h1>
                    <p>ריכזתי כאן את מסלול הלמידה האישי שלי בעולם הבינה המלאכותית. במקום להתפזר, אספתי את המדריכים הכי איכותיים שעזרו לי לחבר את הנקודות – ממתמטיקה בסיסית ועד ל-Transformers.</p>
                    <p>זה לא קורס רשמי, אלא פשוט ריכוז של מקורות שחברים ביקשו ממני לשתף כדי להתחיל ברגל ימין. מוזמנים להשתמש בזה כנקודת זינוק.</p>
